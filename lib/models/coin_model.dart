...
=======================
Description: 
This Page contains Json Generated from https://app.quicktype.io/
Which uses Data from the API ((coingecko))
API Data Link: https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=100&page=1&sparkline=false
=======================
Note: 
omr currency is currently not supported with the plugin (It is sat manually)
*/
